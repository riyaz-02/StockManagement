...
class _T {
  ...
  static const accent =
      Color(0xFF4F46E5); // indigo — required fields, save button
...
class _QuickAddItemScreenState extends State<QuickAddItemScreen> {
  ...
  static const _fallbackItemTypes = [
    'ring',
    'necklace',
    'earring',
    'bracelet',
  ...
  static const _fallbackPurities = [
    '916-22k',
    '750-18k',
    '20kt',
    'jewellery-silver',
  ...
  Future<void> _load() async {
    ...
    if (s.metalTypes.isEmpty || s.purityOptions.isEmpty)
      await s.fetchItemSettings();
    if (!mounted) return;
    ...
    setState(() {
      ...
      _purities =
          s.purityOptions.isNotEmpty ? s.purityOptions : _fallbackPurities;
      _containers = cp.containers.map((c) {
        ...
        return {
          ...
          'status': c.isLocked
              ? 'লক'
              : (!c.isActive ? 'নিষ্ক্রিয়' : (!ok ? 'পূর্ণ' : 'সক্রিয়')),
        };
      }).toList()
        ..sort((a, b) {
  ...
  String _genBarcode() =>
      (DateTime.now().millisecondsSinceEpoch % 90000 + 10000).toString();

  void _refreshBarcode() {
    setState(() {
      _barcode = _genBarcode();
      if (_nameCtrl.text.startsWith('Unnamed - '))
        _nameCtrl.text = 'Unnamed - $_barcode';
    });
  }
  ...
  Future<void> _save() async {
    if (!_canSave) {
      _snack('ধাতু, বিশুদ্ধতা এবং ওজন পূরণ করুন', _T.warn);
      return;
    }
    ...
    if (success) {
      final msg =
          widget.isEditMode ? 'আইটেম আপডেট হয়েছে' : 'সফলভাবে সংরক্ষিত হয়েছে';
            ...
            : Column(children: [
                ...
                Expanded(
                  ...
                  child: Column(children: [
                    ...
                    // 2. Metal
                    _section(
                        label: 'ধাতুর ধরন  (Metal)',
                        icon: Icons.toll_outlined,
                        required: _metalType == null,
                        child: _buildMetalChips()),

                    // 3. Purity
                    _section(
                        label: 'বিশুদ্ধতা  (Purity)',
                        icon: Icons.star_outline_rounded,
                        required: _purity == null,
                        child: _buildPurityChips()),

                    // 4. Weight
                    _section(
                        label: 'নিট ওজন  (Weight gm.)',
                        icon: Icons.scale_outlined,
                        required: _weightCtrl.text.isEmpty,
                        child: _buildWeightRow()),

                    // 5. Certification
                    _section(
                        label: 'সার্টিফিকেশন  (Certification)',
        ...
        Row(children: [
          ...
          Expanded(
            ...
            style: const TextStyle(
                fontSize: 17, fontWeight: FontWeight.w700, color: _T.text1),
          )),
          // Barcode badge
          GestureDetector(
  ...
  Widget _section({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
            color: required ? _T.accent.withValues(alpha: 0.5) : _T.border),
      ),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Padding(
          ...
          return GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                    color: sel ? _T.text1 : _T.border, width: sel ? 1.5 : 1.2),
                boxShadow: sel
                    ? [
                        const BoxShadow(
                            color: Color(0x221A1A2E),
                            blurRadius: 6,
                            offset: Offset(0, 2))
                      ]
                    : null,
  ...
  Widget _buildPurityChips() {
    if (_purities.isEmpty)
      return Text('লোড হচ্ছে...',
          style: TextStyle(color: _T.text3, fontSize: 13));
    return Wrap(
        spacing: 8,
        runSpacing: 8,
        children: _purities.map((v) {
          final sel = _purity == v;
          return GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(24),
                border: Border.all(
                    color: sel ? _T.accent : _T.border, width: sel ? 1.5 : 1.2),
                boxShadow: sel
                    ? [
                        BoxShadow(
  ...
  Widget _buildWeightRow() {
    ...
    return Row(children: [
      Expanded(
        ...
        style: const TextStyle(
            fontSize: 20, fontWeight: FontWeight.w700, color: _T.text1),
        decoration: InputDecoration(
          hintText: '0.000',
          hintStyle: const TextStyle(
              fontSize: 20, color: _T.border, fontWeight: FontWeight.w700),
          suffixText: 'g',
          suffixStyle: TextStyle(
              fontSize: 15,
              fontWeight: FontWeight.w600,
              color: hasVal ? _T.accent : _T.text3),
          filled: true,
          fillColor: _T.bg,
          contentPadding:
      ...
      AnimatedContainer(
        ...
        child: Icon(Icons.scale_rounded,
            color: hasVal ? Colors.white : _T.text3, size: 20),
      ),
    ]);
  }
      ...
      if (_isHUID) ...[
        ...
        TextFormField(
          ...
          inputFormatters: [
            ...
            TextInputFormatter.withFunction((o, n) => TextEditingValue(
  ...
  Widget _certRow(String label, IconData icon, Color color, bool value,
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(10),
          border: Border.all(
              color: value ? color.withValues(alpha: 0.5) : _T.border),
        ),
        child: Row(children: [
          ...
          AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                border:
                    Border.all(color: value ? color : _T.border, width: 1.5),
              ),
              child: value
      ...
      child: Theme(
        ...
        child: ExpansionTile(
          ...
          title: const Text('আরও তথ্য',
              style: TextStyle(
                  fontSize: 13, fontWeight: FontWeight.w600, color: _T.text2)),
          children: [
            const Divider(height: 1, color: _T.border),
            ...
            const SizedBox(height: 6),
            Row(
                children: _weightCategories.map((v) {
            ...
            TextFormField(
                ...
                decoration: _inputDec('যেমন: সোনার আংটি')),
            ...
            TextFormField(
                ...
                maxLines: 2,
                decoration: _inputDec('অতিরিক্ত নোট...')),
            const SizedBox(height: 12),
  ...
  Widget _buildContainerField() {
    if (_containers.isEmpty) {
      return Text('কোনো বাক্স পাওয়া যায়নি',
    ...
    return DropdownButtonFormField<String>(
      ...
      isExpanded: true,
      selectedItemBuilder: (ctx) => _containers
          .map<Widget>((c) => Text('${c['name']} (${c['code']})',
          ...
          child: Opacity(
              ...
              child: Row(children: [
                Icon(ok ? Icons.check_circle_outline : Icons.block,
                    size: 13, color: ok ? _T.success : _T.text3),
                const SizedBox(width: 8),
                Expanded(
                    child: Column(
                      ...
                      Text(
                          '${c['available']}/${c['total']} স্লট · ${c['status']}',
  ...
  Widget _buildStatusChips() {
    const colors = <String, Color>{
      ...
      'in_repair': Color(0xFF7B1FA2),
      'sold': _T.danger,
      'action_needed': _T.warn,
    };
    return Wrap(
        spacing: 7,
        runSpacing: 7,
  ...
  Widget _buildImages() {
    final existE =
        _existingImages.asMap().entries.map((e) => (e.key, e.value, true));
    final newE =
        _newImageUrls.asMap().entries.map((e) => (e.key, e.value, false));
    ...
    return Column(children: [
                ...
                return Stack(children: [
                  ...
                  Positioned(
                      ...
                      child: GestureDetector(
                        onTap: del
                            ? null
                            : () => _deleteImg(idx, existing: isExist),
                        child: Container(
                            padding: const EdgeInsets.all(3),
                            decoration: const BoxDecoration(
                                color: _T.danger, shape: BoxShape.circle),
      ...
      Row(children: [
        Expanded(
            child: _imgBtn(Icons.camera_alt_outlined, 'ক্যামেরা',
                _isUploadingImages, _camera)),
        const SizedBox(width: 8),
        Expanded(
            child: _imgBtn(
                Icons.photo_library_outlined, 'গ্যালারি', false, _gallery)),
      ]),
    ]);
  }
  ...
  InputDecoration _inputDec(String hint, {IconData? prefix}) => InputDecoration(
        hintText: hint,
        prefixIcon:
            prefix != null ? Icon(prefix, size: 17, color: _T.text3) : null,
  ...
  static String _fmt(String v) => v.isEmpty
      ? v
      : v
          .replaceAll('-', ' ')
          .replaceAll('_', ' ')
