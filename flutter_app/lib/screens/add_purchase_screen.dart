...
class _AddPurchaseScreenState extends State<AddPurchaseScreen> {
  ...
  Future<void> _upload({required bool camera}) async {
    ...
    if (mounted) {
      setState(() {
        _isUploading = false;
        if (meta != null) _attachmentMeta.add(meta);
      });
      _snack(meta != null ? 'Bill uploaded ✓' : 'Upload failed',
          isError: meta == null);
    }
  }
  ...
  void _snack(String msg, {bool isError = true}) => showAppSnackBar(
      context,
      SnackBar(
        content: Text(msg),
          ...
          children: [
              ...
              GestureDetector(
                ...
                child: AbsorbPointer(
                  child: TextFormField(
                    ...
                    decoration: _dec(
                        'Invoice Date', Icons.calendar_today_outlined,
            ...
            _card('BILL ATTACHMENTS', [
              ...
              _isUploading
                  ...
                  : Row(children: [
                      Expanded(
                          child: _uploadBtn(Icons.camera_alt_outlined, 'Camera',
                              () => _upload(camera: true))),
                      const SizedBox(width: 10),
                      Expanded(
                  ...
                  ? Padding(
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                            ...
                            maxLines: 3,
                            decoration: _dec('Notes', Icons.note_outlined)),
                      ),
                    )
        ...
        return Expanded(
          child: GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              child: Column(children: [
                Icon(m.icon, size: 17, color: sel ? m.color : Colors.grey[400]),
  ...
  Widget _uploadBtn(IconData icon, String label, VoidCallback onTap) => InkWell(
        onTap: onTap,
        borderRadius: BorderRadius.circular(10),
        child: Container(
  ...
  Widget _r2(String label, String value, Color valueColor,
          {bool bold = false}) =>
  ...
  Widget _tag(String t, Color c) => Container(
        ...
        decoration: BoxDecoration(
            color: c.withAlpha(18), borderRadius: BorderRadius.circular(5)),
        child: Text(t,
            style: TextStyle(
                fontSize: 9,
                fontWeight: FontWeight.w800,
  ...
  String _fmtN(double v) => v.toStringAsFixed(2).replaceAllMapped(
