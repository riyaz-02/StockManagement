...
class _ItemDetailsScreenState extends State<ItemDetailsScreen> {
                            ...
                            child: BackdropFilter(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Icon(_getStatusIcon(_item.status),
            ...
            Padding(
              ...
              child: Column(
                children: [
                          ...
                          children: [
                            ...
                            Expanded(
                              child: _buildCompactBox(
                                  ...
                                  'Weight Category',
                                  _item.weightCategory.isNotEmpty
                                      ? _item.weightCategory
                                      : 'N/A',
                                  Colors.teal),
                            ),
                          ],
                            ...
                            onTap: () async {
                              ...
                              try {
                                final containerProvider =
                                    Provider.of<ContainerProvider>(context,
                                        listen: false);
                                await containerProvider
                                    .fetchContainer(widget.item.containerId!);

                                if (containerProvider.selectedContainer !=
                                        null &&
                                    mounted) {
                                  Navigator.push(
                                    context,
                                ...
                                if (mounted) {
                                  showAppSnackBar(
                                    ...
                                    SnackBar(
                                      content:
                                          Text('Error loading container: $e'),
                  ...
                  if (['UNDER_REPAIR', 'WITH_CUSTOMER', 'WITH_AGENT']
                    ...
                    FutureBuilder(
                      ...
                      builder: (context, snapshot) {
                        ...
                        if (snapshot.hasData &&
                          ...
                          final movements =
                              snapshot.data!['data']['movements'] as List;
                            ...
                            return Padding(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  gradient: LinearGradient(
                                    colors: [
                                      activeMovement['movementType'] == 'REPAIR'
                                  ...
                                  borderRadius: BorderRadius.circular(12),
                                  border: Border.all(
                                    color: activeMovement['movementType'] ==
                                            'REPAIR'
                                        ? Colors.orange
                                        : activeMovement['movementType'] ==
                                                'CUSTOMER_TRIAL'
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      // Movement details
                                      _buildMovementDetailRow(
                                          'Out Date',
                                          activeMovement['outDate']
                                                  ?.toString()
                                                  .split('T')[0] ??
                                              'N/A'),
                                      ...
                                      if (activeMovement['givenTo'] != null)
                                        _buildMovementDetailRow('Given To',
                                            activeMovement['givenTo']),
                                      if (activeMovement['repairType'] !=
                                              null &&
                                          activeMovement['repairType']
                                              .toString()
                                              .isNotEmpty)
                                        _buildMovementDetailRow('Repair Type',
                                            activeMovement['repairType']),
                                      if (activeMovement['jobCardNumber'] !=
                                              null &&
                                          activeMovement['jobCardNumber']
                                              .toString()
                                              .isNotEmpty)
                                        _buildMovementDetailRow('Job Card',
                                            activeMovement['jobCardNumber']),

                                      // Customer trial specific
                                      if (activeMovement['customerName'] !=
                                          null)
                                        _buildMovementDetailRow('Customer',
                                            activeMovement['customerName']),
                                      if (activeMovement['customerMobile'] !=
                                          null)
                                        _buildMovementDetailRow('Mobile',
                                            activeMovement['customerMobile']),
                                      if (activeMovement['idProofType'] !=
                                              null &&
                                          activeMovement['idProofType']
                                              .toString()
                                              .isNotEmpty)
                                        _buildMovementDetailRow('ID Proof',
                                            activeMovement['idProofType']),

                                      // Agent consignment specific
                                      if (activeMovement['partyName'] != null)
                                        _buildMovementDetailRow('Party',
                                            activeMovement['partyName']),
                                      if (activeMovement['partyType'] != null)
                                        _buildMovementDetailRow('Party Type',
                                            activeMovement['partyType']),
                                      if (activeMovement['gstin'] != null &&
                                          activeMovement['gstin']
                                              .toString()
                                              .isNotEmpty)
                                        _buildMovementDetailRow(
                                            'GSTIN', activeMovement['gstin']),
                                      if (activeMovement['challanNumber'] !=
                                              null &&
                                          activeMovement['challanNumber']
                                              .toString()
                                              .isNotEmpty)
                                        _buildMovementDetailRow('Challan',
                                            activeMovement['challanNumber']),
                                      ...
                                      if (activeMovement[
                                        ...
                                        _buildMovementDetailRow(
                                            ...
                                            activeMovement['expectedReturnDate']
                                                    ...
                                                    .split('T')[0] ??
                                                'N/A'),
                                      if (activeMovement['remarks'] != null &&
                                          activeMovement['remarks']
                                              .toString()
                                              .isNotEmpty)
                                        _buildMovementDetailRow('Remarks',
                                            activeMovement['remarks'],
                                            isRemark: true),
                                    ],
                                  ),
                  ...
                  if (['UNDER_REPAIR', 'WITH_CUSTOMER', 'WITH_AGENT']
                    ...
                    Padding(
                      ...
                      child: ElevatedButton.icon(
                        onPressed: () =>
                            _showReturnToStockConfirmation(context),
              ...
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      backgroundColor:
                          isSelling ? Colors.grey : AppColors.success,
                      padding: const EdgeInsets.symmetric(vertical: 14),
                    ),
                    onPressed: isSelling
                        ? null
                        : () async {
                            ...
                            try {
                              ...
                              final response =
                                  await _apiService.sellItem(_item.id, data);
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                    ...
                    decoration: const InputDecoration(
                        labelText: 'Repair Center / Vendor',
                        border: OutlineInputBorder(),
                ...
                TextField(
                    ...
                    decoration: const InputDecoration(
                        labelText: 'Repair Type (e.g. Polish, Stone Fix)',
                        border: OutlineInputBorder(),
                      ...
                      : () async {
                          if (vendorController.text.isEmpty ||
                            ...
                            showAppSnackBar(
                                ...
                                const SnackBar(
                                    content:
                                        Text('Vendor and Type are required')));
                            return;
                          }
                          ...
                          try {
                            ...
                            final response =
                                await _apiService.sendToRepair(data);
      ...
      if (_item.containerId != null && _item.containerId!.isNotEmpty) {
        ...
        if (previousContainer != null &&
          ...
          await _restoreItemToContainer(
              _item, _item.containerId!, _item.slotNumber);
          return;
        }
      }
  ...
  void _showMarkAsNoSellConfirmation(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
            'This item will be marked as not available for sale. You can change it back to active later.'),
        actions: [
          TextButton(
              onPressed: () => Navigator.pop(context),
              child: const Text('Cancel')),
              ...
              try {
                ...
                if (mounted) {
                  showAppSnackBar(
                    context,
                    const SnackBar(
                        content: Text('Item marked as no sell'),
                        backgroundColor: Colors.green),
                  );
                  _refreshData();
                }
  ...
  void _showMarkAsActiveConfirmation(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
            'This item will be marked as active and available for sale again.'),
        actions: [
          TextButton(
              onPressed: () => Navigator.pop(context),
              child: const Text('Cancel')),
  ...
  void _showReturnToStockConfirmation(BuildContext context) async {
    ...
    try {
      ...
      final netWeightController =
          TextEditingController(text: _item.netWeight.toString());
      ...
      showModalBottomSheet(
        ...
        builder: (context) => StatefulBuilder(
          builder: (context, setSheetState) {
            final currentWeight =
                double.tryParse(netWeightController.text) ?? originalWeight;
                ...
                child: Column(
                  ...
                  children: [
                            ...
                            children: [
                              const Text('Return to Stock',
                                  style: TextStyle(
                                      fontSize: 20,
                                      fontWeight: FontWeight.bold)),
                              Text('Update item details if changed',
                                  style: TextStyle(
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8),
                          Text(
                              'Out Date: ${activeMovement['outDate']?.toString().split('T')[0] ?? 'N/A'}',
                              style: const TextStyle(fontSize: 12)),

                          // Repair-specific details
                          if (activeMovement['givenTo'] != null)
                            Text('Given To: ${activeMovement['givenTo']}',
                                style: const TextStyle(fontSize: 12)),
                          if (activeMovement['repairType'] != null &&
                              activeMovement['repairType']
                                  .toString()
                                  .isNotEmpty)
                            Text('Repair Type: ${activeMovement['repairType']}',
                                style: const TextStyle(fontSize: 12)),
                          if (activeMovement['jobCardNumber'] != null &&
                              activeMovement['jobCardNumber']
                                  .toString()
                                  .isNotEmpty)
                            Text('Job Card: ${activeMovement['jobCardNumber']}',
                                style: const TextStyle(fontSize: 12)),

                          // Customer trial details
                          if (activeMovement['customerName'] != null)
                            Text('Customer: ${activeMovement['customerName']}',
                                style: const TextStyle(fontSize: 12)),
                          if (activeMovement['customerMobile'] != null)
                            Text('Mobile: ${activeMovement['customerMobile']}',
                                style: const TextStyle(fontSize: 12)),
                          if (activeMovement['idProofType'] != null &&
                              activeMovement['idProofType']
                                  .toString()
                                  .isNotEmpty)
                            Text('ID Proof: ${activeMovement['idProofType']}',
                                style: const TextStyle(fontSize: 12)),

                          // Agent consignment details
                          if (activeMovement['partyName'] != null)
                            Text('Party: ${activeMovement['partyName']}',
                                style: const TextStyle(fontSize: 12)),
                          if (activeMovement['partyType'] != null)
                            Text('Party Type: ${activeMovement['partyType']}',
                                style: const TextStyle(fontSize: 12)),
                          if (activeMovement['gstin'] != null &&
                              activeMovement['gstin'].toString().isNotEmpty)
                            Text('GSTIN: ${activeMovement['gstin']}',
                                style: const TextStyle(fontSize: 12)),
                          if (activeMovement['challanNumber'] != null &&
                              activeMovement['challanNumber']
                                  .toString()
                                  .isNotEmpty)
                            Text('Challan: ${activeMovement['challanNumber']}',
                                style: const TextStyle(fontSize: 12)),

                          // Common fields
                          if (activeMovement['expectedReturnDate'] != null)
                            Text(
                                'Expected Return: ${activeMovement['expectedReturnDate']?.toString().split('T')[0] ?? 'N/A'}',
                                style: const TextStyle(fontSize: 12)),
                          if (activeMovement['remarks'] != null &&
                              activeMovement['remarks'].toString().isNotEmpty)
                            Text('Remarks: ${activeMovement['remarks']}',
                                style: const TextStyle(
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        helperStyle: TextStyle(
                          color:
                              weightChange > 0 ? Colors.green : Colors.orange,
                          fontWeight: FontWeight.bold,
                        ),
                      ),
                      keyboardType: TextInputType.number,
                    ...
                    ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        backgroundColor:
                            isReturning ? Colors.grey : Colors.blue,
                        padding: const EdgeInsets.symmetric(vertical: 14),
                      ),
                      onPressed: isReturning
                          ...
                          : () async {
                              // Validation
                              if (netWeightController.text.isEmpty ||
                              ...
                              try {
                                ...
                                final response = await _apiService
                                    .returnItem(activeMovement['_id']);

                                // Update item details if weight or purity changed
                                if (weightChange != 0 ||
                                    purityController.text != _item.purity) {
  ...
  void _showBookingBottomSheet(
      ...
      bool viewOnly = false}) {
    final nameController = TextEditingController(
        text: initialData?['name'] ?? initialData?['customerName']);
    final mobileController =
        TextEditingController(text: initialData?['mobile']);
    final addressController =
        TextEditingController(text: initialData?['address']);
    final advanceController = TextEditingController(
        text: initialData?['advance']?.toString() ??
            initialData?['advanceAmount']?.toString());
    final remarksController =
        TextEditingController(text: initialData?['remarks']);

    DateTime? selectedDate = initialData?['expiryDate'] != null
        ? DateTime.tryParse(initialData!['expiryDate'])
        : null;
            ...
            child: Column(
              ...
              children: [
                Text(
                    viewOnly
                        ? 'Booking Details'
                        : (isEditing ? 'Update Booking' : 'Book Item'),
                    style: Theme.of(context).textTheme.headlineSmall),
                const SizedBox(height: 16),
                TextField(
                    enabled: !viewOnly,
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      try {
                        ...
                        if (isEditing) {
                          response =
                              await _apiService.updateBooking(bookingId, data);
                        } else {
            ...
            if (booked.isNotEmpty) ...[
              ...
              ...booked.map((b) => ListTile(
                    ...
                    trailing: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        Text(b['bookingDate']?.toString().split('T')[0] ?? '',
                            style: const TextStyle(
                        ...
                        PopupMenuButton<String>(
                          ...
                          onSelected: (value) {
                            ...
                            if (value == 'modify')
                              _showBookingBottomSheet(
                                  initialData: b, bookingId: b['id']);
                            if (value == 'order_given')
                              _updateBookingStatus(b['id'], 'manufacturing');
                            if (value == 'view')
                              _showBookingBottomSheet(
                                  initialData: b, viewOnly: true);
                          },
            ...
            if (wishlisted.isNotEmpty) ...[
              ...
              ...wishlisted.map((w) => ListTile(
                    ...
                    title: Text(w['name'] ?? 'Unknown',
                        style: const TextStyle(fontSize: 13)),
                    subtitle: Text(w['mobile'] ?? '',
                        style: const TextStyle(fontSize: 11)),
                    trailing: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        Text(w['date']?.toString().split('T')[0] ?? '',
                            style: const TextStyle(
                                fontSize: 10, color: Colors.grey)),
                        const SizedBox(width: 8),
                        InkWell(
  ...
  Future<void> _updateBookingStatus(String id, String status) async {
    try {
      ...
      showAppSnackBar(context, const SnackBar(content: Text('Status Updated')));
      _refreshData();
    } catch (e) {
      showAppSnackBar(context, SnackBar(content: Text('Error: $e')));
    }
  ...
  Future<void> _removeFromWishlist(String mobile) async {
    try {
      ...
      showAppSnackBar(
          context, const SnackBar(content: Text('Removed from wishlist')));
      _refreshData();
    } catch (e) {
      showAppSnackBar(context, SnackBar(content: Text('Error: $e')));
    }
  ...
  Future<void> _cancelBooking(String bookingId) async {
    ...
    try {
      ...
      showAppSnackBar(
          context, const SnackBar(content: Text('Booking Cancelled')));
      _refreshData();
    } catch (e) {
      showAppSnackBar(context, SnackBar(content: Text('Error: $e')));
    }
              ...
              children: [
                ...
                if (selectedMovementType == 'REPAIR') ...[
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    items: const [
                      ...
                      DropdownMenuItem(
                          value: 'Stone Setting', child: Text('Stone Setting')),
                      DropdownMenuItem(
                          value: 'Chain Repair', child: Text('Chain Repair')),
                      DropdownMenuItem(
                          value: 'Clasp Repair', child: Text('Clasp Repair')),
                      DropdownMenuItem(
                          value: 'Engraving', child: Text('Engraving')),
                ...
                InkWell(
                  onTap: () async {
                    ...
                    if (date != null)
                      setSheetState(() => expectedReturnDate = date);
                  },
                  child: InputDecorator(
                    decoration: const InputDecoration(
                        labelText: 'Expected Return Date',
                        border: OutlineInputBorder(),
                        prefixIcon: Icon(Icons.calendar_today)),
                    child: Text(expectedReturnDate != null
                      ...
                      : () async {
                          ...
                          if (selectedMovementType == null) {
                            showAppSnackBar(
                                ...
                                const SnackBar(
                                    content:
                                        Text('Please select movement type')));
                            return;
                          }

                          if (selectedMovementType == 'REPAIR' &&
                              givenToController.text.isEmpty) {
                            showAppSnackBar(
                                context,
                                const SnackBar(
                                    content: Text(
                                        'Given To is required for repair')));
                            return;
                          }
                          ...
                          if (selectedMovementType == 'AGENT_CONSIGNMENT') {
                            if (partyNameController.text.isEmpty ||
                              ...
                              showAppSnackBar(
                                  ...
                                  const SnackBar(
                                      content: Text(
                                          'Party name and type are required')));
                              return;
                            }
                          }
                          ...
                          try {
                            ...
                            final response =
                                await _apiService.createOutwardMovement(data);

                            if (response['success'] == true) {
                              Navigator.pop(context);
                              _showMoveOutSuccessDialog(
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    showAppSnackBar(
                      context,
                      const SnackBar(
                          content: Text('Challan generation coming soon')),
                    );
                  },
  ...
  Widget _buildMovementDetailRow(String label, String value,
      {bool isRemark = false}) {
    return Padding(
      padding: const EdgeInsets.only(bottom: 8),
      child: Row(
